...
var supabase = (0, import_supabase_js.createClient)("https://pvyvzfpfyqwdbjbxegzw.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzMjcxNTM1NSwiZXhwIjoxOTQ4MjkxMzU1fQ.Pdb-d7UmSDY5f3a1xtTUrivmx8nEhpsfXtA-6sw470Q");
function user() {
...
var Signout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  signout$1();
  return `Signout`;
});
...
var Policy = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `policy`;
});
