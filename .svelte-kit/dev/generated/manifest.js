...
export const routes = [
	...
	// src/routes/account/setting/index.svelte
	[/^\/account\/setting\/?$/, [c[0], c[3]], [c[1]]],

	// src/routes/account/setting/[page].svelte
	[/^\/account\/setting\/([^/]+?)\/?$/, [c[0], c[4]], [c[1]], (m) => ({ page: d(m[1])})],

	// src/routes/account/signout.svelte
	[/^\/account\/signout\/?$/, [c[0], c[5]], [c[1]]],

	// src/routes/account/signin.svelte
	[/^\/account\/signin\/?$/, [c[0], c[6]], [c[1]]],
